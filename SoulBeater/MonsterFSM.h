...
namespace soulBeater
{
	...
	public:
		...
		inline const std::map<unsigned int, eMonsterState>& GetMonsterMaps() const;
	...
	private:
		...
		std::map<unsigned int, eMonsterState> mMonsterMaps;
	...
	const std::map<unsigned int, eMonsterState>& MonsterFSM::GetMonsterMaps() const
	{
		return mMonsterMaps;
	}
}